...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 27, 2024 lúc 10:21 AM
...
(33, 'Văn hiệp', 'vanhiep@gmail.com', 'xin chào', '2024-06-19 15:10:57');
...
('20214049FL1219', 20214049, 'FL1219', 7, 8, 0, 0, 8, 7.9, 'B', ''),
...
--
-- Cấu trúc bảng cho bảng `qlphamtramd`
--

CREATE TABLE `qlphamtramd` (
  `maptd` int(11) NOT NULL,
  `chuyencan` int(11) NOT NULL DEFAULT 10,
  `diemgiuaky` int(11) NOT NULL DEFAULT 20,
  `diemthi` int(11) NOT NULL DEFAULT 70
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Đang đổ dữ liệu cho bảng `qlphamtramd`
--

INSERT INTO `qlphamtramd` (`maptd`, `chuyencan`, `diemgiuaky`, `diemthi`) VALUES
(1, 10, 20, 70);
...
CREATE TABLE `qlsinhvien` (
  ...
  `NGAYTHEM` datetime NOT NULL DEFAULT current_timestamp(),
  `anhsv` varchar(500) NOT NULL DEFAULT 'default.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `qlsinhvien` (`MASV`, `MAK`, `khoahoc`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `TBCHT`, `XEPLOAI`, `NGAYTHEM`, `anhsv`) VALUES
(1, 'MK01', 'K12', 'Lê Đình Hiếu', '0017-12-15', 'Nữ', 0, NULL, '2024-06-27 15:09:16', 'default.png'),
(2, 'MK01', 'K12', 'Lê Đình Hiếu', '0024-12-14', 'Nữ', 0, NULL, '2024-06-27 15:09:33', '2.png'),
(20213134, 'MK01', 'K12', 'nguyen van hie', '3900-02-01', 'nam', 0, NULL, '2024-06-22 13:24:55', '20213134.png'),
(20214045, 'MK01', 'K13', 'Lê Đình Hi', '3900-02-01', 'nam', 0, 'Kém', '2023-12-16 21:16:04', 'default.png'),
(20214046, 'MK01', 'K12', 'Lê Đình Hiếu', '2023-12-15', 'nam', 8.4, 'Giỏi', '2023-12-17 03:46:09', 'default.png'),
(20214047, 'MK01', 'K12', 'Lê Đình Hiếu', '2023-12-14', 'nam', 7.950000000000001, 'Khá', '2023-12-17 04:00:22', 'default.png'),
(20214048, 'MK01', 'K12', 'Lê Đình Hiếu', '2023-12-22', 'Nữ', 3.0666666666666664, 'Kém', '2023-12-17 18:27:16', 'default.png'),
(20214049, 'MK01', 'K12', 'Lê Đình Hiếu', '2023-12-23', 'nam', 0, 'Kém', '2023-12-17 18:27:35', 'default.png'),
(20214051, 'MK03', 'K12', 'Lê Đình Hiếu', '3900-02-01', 'nam', 0, 'Kém', '2023-12-20 16:08:00', 'default.png'),
(20214060, 'MK01', 'K13', 'Phạm Siu Nhậm', '3900-02-01', 'Nữ', 0, NULL, '2024-06-22 00:12:43', 'default.png'),
(20214061, 'MK01', 'K13', 'Đào Văn B', '0025-12-15', 'Nữ', 0, NULL, '2024-06-22 00:13:13', 'default.png'),
(20214062, 'MK01', 'K12', 'Nguyễn Văn A', '3900-02-01', 'nam', 0, NULL, '2024-06-22 04:41:42', 'default.png');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `qlvaitro`
--

CREATE TABLE `qlvaitro` (
  `mavt` int(11) NOT NULL,
  `tenvt` varchar(20) NOT NULL,
  `qltaikhoan` tinyint(1) NOT NULL DEFAULT 0,
  `qldiem` tinyint(1) NOT NULL DEFAULT 0,
  `qlmonhoc` tinyint(1) NOT NULL DEFAULT 0,
  `qlsinhvien` tinyint(1) NOT NULL DEFAULT 0,
  `qllienhe` tinyint(1) NOT NULL DEFAULT 0,
  `qlphantramd` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Đang đổ dữ liệu cho bảng `qlvaitro`
--

INSERT INTO `qlvaitro` (`mavt`, `tenvt`, `qltaikhoan`, `qldiem`, `qlmonhoc`, `qlsinhvien`, `qllienhe`, `qlphantramd`) VALUES
(1, 'Mặc định', 0, 0, 0, 0, 0, 0),
(5, 'Quản lý', 1, 1, 1, 1, 1, 1),
(6, 'Giáo viên', 0, 1, 0, 1, 0, 0);
...
INSERT INTO `taikhoan` (`username`, `password`, `duyet`, `mavt`) VALUES
('admin', 'admin', 'on', 5),
('hoanglong', '123', 'off', 1),
('lehi', '123', 'on', 1),
('lehieu123', '12345', 'off', 1),
('lehieu1234', '1234', 'off', 1),
('vanhiep', '12345', 'on', 6);
...
--
-- Chỉ mục cho bảng `qlphamtramd`
--
ALTER TABLE `qlphamtramd`
  ADD PRIMARY KEY (`maptd`);
...
--
-- Chỉ mục cho bảng `qlvaitro`
--
ALTER TABLE `qlvaitro`
...
--
ALTER TABLE `lienhe`
  MODIFY `idcm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT cho bảng `qlphamtramd`
--
ALTER TABLE `qlphamtramd`
  MODIFY `maptd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `qlvaitro`
--
ALTER TABLE `qlvaitro`
  MODIFY `mavt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `taikhoan`
  ADD CONSTRAINT `key_mavt` FOREIGN KEY (`mavt`) REFERENCES `qlvaitro` (`mavt`);
COMMIT;
